<?php /* Smarty version 2.6.27, created on 2014-11-16 00:53:40
         compiled from Employers.tpl */ ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Administracion de empleados. <small>Altas y bajas</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Aqui podras dar de alta un nuevo empleado, o desactivarlo.
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                          <p class="text-center"> Lista Empleados </p>
                        </div>
                    </div>
                </div>

          <!--************Tabla reclamos ***********-->
          <div  id="div_table_employers">
                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "table_employers.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
          </div>
