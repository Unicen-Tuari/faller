...
<body >
                        ...
                        <div class="panel panel-primary">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left">Ver Detalles del usuario</span>
 ...
 <div class="col-lg-7 col-sm-1 placeholder offset3"  id="cuadro_del_reclamo">   
      
      allalal
</div> 
<div class="col-lg-5 col-sm-1 placeholder offset3"  id="foto_reclamo">   
</div> 
