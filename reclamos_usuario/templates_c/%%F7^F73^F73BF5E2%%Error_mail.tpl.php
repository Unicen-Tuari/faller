<?php /* Smarty version 2.6.27, created on 2014-11-25 02:13:01
         compiled from Error_mail.tpl */ ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <form class="form-horizontal"  id="formLoginEmail"  method="post">
                <input type="hidden" id="id_claim_e" value="<?php echo $this->_tpl_vars['id_claim_email']; ?>
">
                <input type="hidden" name="id_person_of_reclaim" value="<?php echo $this->_tpl_vars['id_person_of_reclaim']; ?>
">
