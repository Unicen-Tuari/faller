<?php /* Smarty version 2.6.27, created on 2014-10-14 20:10:57
...
<body >
 ...
 <div class="col-lg-9 col-sm-1 placeholder offset3"  id="cuadro_del_reclamo">   
         <div class="container col-lg-12">
        <ul class="nav nav-tabs" id="myTab">
          <li class="active"><a href="#profile" data-toggle="tab">Mi Reclamo</a></li>
          <li><a href="#messages" data-toggle="tab">Sector 1</a></li>
